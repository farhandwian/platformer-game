...
public class Menu extends javax.swing.JFrame {
    ...
    //untuk nampilin table di menunya
    public void updateTable() {
        // mengambli data dari database
        List<Score> scores = this.tablescore.getAll();
        ...
        for(Score sc : scores){
            ...
            row[0] = sc.getUsername();
            row[1] = sc.getAdapt();
            row[2] = sc.getFall();
            dataTable.addRow(row);
        }
        
        TableScore.setModel(dataTable);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Farhan Dwian|2002969");
    ...
    private void btn_playActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_playActionPerformed
        if(!TF_Username.getText().equals("")){
            // membuat Frame Game
            PlatformerGameCall pg = new PlatformerGameCall(TF_Username.getText(), this);
            setVisible(false);
        }else{
